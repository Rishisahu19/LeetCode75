...
//     long long solve(vector<int> &nums1, vector<int> &nums2, int sum, int min_el,
//                     int i, int count)
//     {
//         if (count == K)
//         {
...
//         string key = to_string(sum) + "" + to_string(min_el) + "" +
//                      to_string(i) + "_" + to_string(count);
...
//         long take_i =
//             solve(nums1, nums2, sum + nums1[i], min_now, i + 1, count + 1);
...
// // Approach 2: Greedy + Priority Queue + Sorting
